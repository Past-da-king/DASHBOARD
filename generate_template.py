...
def create_professional_template(sample_data=False):
    ...
    values_sample = [
        ('C5', 'Liberty Tower Fibre Relocation'),
        ('C6', 'IN963051'),
        ('C7', 'Liberty Properties'),
        ('C8', 'J. Smith'),
    ]
    ...
    # --- PROJECT SCHEDULE TABLE (Gantt Chart as Table) ---
    ws1['A10'] = "PROJECT SCHEDULE (BASELINE PLAN)"
    ws1['A10'].font = TITLE_FONT
    
    schedule_headers = ['Activity ID', 'Activity Name', 'Planned Start', 'Planned End', 'Budgeted Cost (R)', 'Depends On', 'Actual Start', 'Actual End']
    ...
    if sample_data:
        schedule_data = [
            [1, 'Site Survey & Mobilization', datetime(2025,1,15), datetime(2025,1,20), 15000, '-', datetime(2025,1,15), datetime(2025,1,19)],
            [2, 'Civil Works - Trenching', datetime(2025,1,21), datetime(2025,2,15), 45000, 1, datetime(2025,1,21), datetime(2025,2,18)],
            [3, 'Fibre Cable Laying', datetime(2025,2,1), datetime(2025,3,15), 60000, 2, datetime(2025,2,5), None],
            [4, 'Fibre Splicing', datetime(2025,3,16), datetime(2025,4,15), 35000, 3, None, None],
            [5, 'Testing & Commissioning', datetime(2025,4,16), datetime(2025,5,15), 25000, 4, None, None],
            [6, 'Site Restoration & Handover', datetime(2025,5,16), datetime(2025,6,15), 20000, 5, None, None],
        ]
...
if __name__ == '__main__':
    ...
    print("  2. Project_Template_Sample.xlsx (Example with Liberty Towers data)")
    print("=" * 60)
